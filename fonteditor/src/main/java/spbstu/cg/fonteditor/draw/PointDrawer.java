...
public class PointDrawer {
    ...
    private static final int HANDLE_POINT_RADIUS = 2;

    private static final Color CONTROL_POINT_COLOR = Color.black;
    private static final Color HANDLE_POINT_COLOR = Color.blue;

    static {
        RADIUS_MAP = new HashMap<Class<? extends Point>, Integer>(NUMBER_OF_POINT_TYPES);
        COLOR_MAP = new HashMap<Class<? extends Point>, Color>(NUMBER_OF_POINT_TYPES);
